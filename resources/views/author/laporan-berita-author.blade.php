...
<body>
    ...
    <a href="/home" class="brand-name">
        ...
        <ul>
            ...
            <li >
              <a  class="aktif" href="laporan-berita-author">
    ...
    <div class="container">
        ...
        <div class="content">
            <div class="cards">
            <a href="/berita-buruk-author" style="color:black" class="laporan">
                      <i class='bx bx-error-circle bx-lg bx-border' style="color: #ED4337;border:none" ></i>
                      <div>
                          <h2>Rating Buruk</h2>
                ...
                <div class="laporan">
                    <i class='bx bx-category  bx-lg bx-border' style="color: #009AE1;border:none"></i>
                    <div>
                ...
                <div class="laporan">
                    <i class='bx bxs-report  bx-lg bx-border' style="color: #7805A0;border:none"></i>
                    <div>
                        <h2>Total berita</h2>
                  ...
                  <table class="myTable">
                    ...
                    <td>{{ $index + $tabelbawah->firstItem() }}</td>
                      ...
                      <td>
                        ...
                        <form method="DELETE" action="{{ route('hapusartikelauthor', [$data->id]) }}" onsubmit="return confirm('Hapus Berita Ini?')">
                          {{ csrf_field() }}
                          {{ method_field('DELETE') }}  
